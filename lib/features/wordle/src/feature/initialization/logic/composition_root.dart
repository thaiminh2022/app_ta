...
import 'package:app_ta/features/wordle/src/core/constant/application_config.dart';
import 'package:app_ta/features/wordle/src/core/utils/logger/logger.dart';
import 'package:app_ta/features/wordle/src/feature/game/data/game_datasource.dart';
import 'package:app_ta/features/wordle/src/feature/game/data/game_repository.dart';
import 'package:app_ta/features/wordle/src/feature/initialization/model/dependencies_container.dart';
...
import 'package:app_ta/features/wordle/src/feature/settings/data/app_settings_datasource.dart';
import 'package:app_ta/features/wordle/src/feature/settings/data/app_settings_repository.dart';
import 'package:app_ta/features/wordle/src/feature/statistic/data/statistics_datasource.dart';
...
Future<DependenciesContainer> createDependenciesContainer(
  ...
  await gameRepository.init(
    appSettingsBloc.state.appSettings?.dictionary ?? const Locale('en'),
  );

  final ILevelDatasource levelDataSource = LevelDatasource(
