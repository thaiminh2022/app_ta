...
import 'package:app_ta/features/wordle/src/core/resources/resources.dart';
import 'package:app_ta/features/wordle/src/core/utils/extensions/extensions.dart';
import 'package:app_ta/features/wordle/src/feature/components/widget/constraint_screen.dart';
import 'package:app_ta/features/wordle/src/feature/components/widget/letter_tile.dart';
import 'package:app_ta/features/wordle/src/feature/game/model/letter_info.dart';
import 'package:app_ta/features/wordle/src/feature/settings/bloc/app_settings_bloc.dart';
import 'package:app_ta/features/wordle/src/feature/settings/model/app_theme.dart';
import 'package:app_ta/features/wordle/src/feature/settings/model/change_color_result.dart';
...
class _ChangeColorPageState extends State<ChangeColorPage> {
  ...
  void initState() {
    ...
    _currentOtherColors =
        widget.previousResult.otherColors ??
        (AppColors.green, AppColors.yellow, AppColors.grey);
  }
              ...
              ColorPicker(
                ...
                pickerColor:
                    _currentColorByStatus(
                      ...
                      _currentSelectedTileIndex == null
                          ? null
                          : word[_currentSelectedTileIndex!].status,
                    ) ??
                  ...
                  setState(() {
                    _currentOtherColors = (
                      status == LetterStatus.correctSpot
                          ? color
                          : _currentOtherColors.$1,
                      status == LetterStatus.wrongSpot
                          ? color
                          : _currentOtherColors.$2,
                      status == LetterStatus.notInWord
                          ? color
                          : _currentOtherColors.$3,
                    );
                    _changeTheme(context);
                  });
                },
  ...
  List<LetterInfo> _wordByDictionary(Locale dictionary) => switch (dictionary
      .languageCode) {
    'en' => const [
