...
import 'package:app_ta/features/wordle/src/feature/settings/widget/change_color_page.dart';
import 'package:app_ta/features/wordle/src/feature/settings/widget/list_item_selector.dart';
          ...
          child: Column(
            children: [
              ListItemSelector<Locale>(
                ...
                items: [
                  (const Locale('ru'), context.l10n.ru),
                  (const Locale('en'), context.l10n.en),
                ],
                onChange: (d) {
                  final appSettingsBloc = SettingsScope.of(
                    context,
                    listen: false,
                  );
                  final appSettings = SettingsScope.settingsOf(
                    context,
                    listen: false,
                  );
                  appSettingsBloc.add(
              ...
              ListItemSelector<ThemeMode>(
                ...
                currentValue: (
                  settings.appTheme.themeMode,
                  _themeName(settings.appTheme.themeMode),
                ),
                items: [
                  ...
                  appSettingsBloc.add(
                    AppSettingsEvent.updateAppSettings(
                      appSettings: appSettings.copyWith(
                        appTheme: appSettings.appTheme.copyWith(themeMode: tm),
                      ),
                    ),
                  );
                },
                  ...
                  child: ListTile(
                    ...
                    trailing: Text(
                      SettingsScope.settingsOf(
                        context,
                      ).appTheme.colorMode.localized(context),
                      style: const TextStyle(
                        fontSize: 16,
                        fontWeight: FontWeight.w500,
                      ),
