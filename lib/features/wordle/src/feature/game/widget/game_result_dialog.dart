...
import 'package:app_ta/features/wordle/src/feature/game/widget/countdown_timer.dart';
      ...
      child: Padding(
        ...
        child: SizedBox(
          ...
          child: Column(
            ...
            children: [
              Text(
                (isWin ? context.l10n.winMessage : context.l10n.loseMessage)
                    .toUpperCase(),
