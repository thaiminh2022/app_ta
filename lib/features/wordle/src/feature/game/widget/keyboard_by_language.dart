...
import 'package:app_ta/features/wordle/src/core/assets/generated/fonts.gen.dart';
      ...
      child: SizedBox(
        ...
        child: Material(
          ...
          child: InkWell(
            onTap:
                () => context.read<GameBloc>().add(
                  const GameEvent.deletePressed(),
                ),
            onLongPress:
                () => context.read<GameBloc>().add(
                  const GameEvent.deleteLongPressed(),
                ),
            child: Padding(
              padding: const EdgeInsets.symmetric(vertical: 12, horizontal: 4),
              child: FittedBox(
