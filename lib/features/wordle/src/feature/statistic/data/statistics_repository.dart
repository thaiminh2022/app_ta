...
final class StatisticsRepository implements IStatisticsRepository {
  const StatisticsRepository({
    required IStatisticsDatasource statisticsDatasource,
  ...
  Future<void> setStatistics(
    ...
    final previousStatistic = await _statisticsDatasource.getStatistics(
    ...
    final currentStatistic = GameStatistics(
      ...
      streak: _calculateStreak(
        isWin: isWin,
        previous: previousStatistic?.streak,
      ),
    ...
    await _statisticsDatasource.setStatistics(
      dictionary.languageCode,
      currentStatistic,
    );
  }
